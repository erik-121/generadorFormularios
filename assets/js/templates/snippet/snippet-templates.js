define(function(require) {
  var formname                 = require('text!templates/snippet/formname.php'), 
	  ...
	  filebutton               = require('text!templates/snippet/filebutton.php'),
	  ...
	  selectbasic              = require('text!templates/snippet/selectbasic.php'),
